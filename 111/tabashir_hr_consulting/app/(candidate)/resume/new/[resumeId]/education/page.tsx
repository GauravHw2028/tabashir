...
export default function EducationPage({ params }: { params: { resumeId: string } }) {
      ...
      education: [
        {
          ...
          endDate: "2022-06",
          city: "Islamabad",
          description: "Graduated with honors. Specialized in UI/UX design and front-end development.",
        },
      ],
    },
  })
  ...
  const onSubmit = async (data: EducationFormValues) => {
    ...
    try {
      ...
      router.push(`/resume/new/${params.resumeId}/skills`)
    } catch (error) {
      toast({
        title: "Error",
