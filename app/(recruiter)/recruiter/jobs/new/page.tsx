...
import { createRecruiterJob } from "@/actions/job"
...
export default function CreateJobPage() {
  ...
  const onSubmit = async (data: JobFormData) => {
    try {
      ...
      const result = await createRecruiterJob(data)
      ...
      if (result.success) {
        ...
        toast.error("Error creating job", {
          description: result.error || "There was an error creating your job posting. Please try again.",
